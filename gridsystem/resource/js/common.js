...
$(document).ready(function () {
    ...
    function menPackmo() {
        if ($('.menuCategory li.selected').length == 1) {
            let l_pos = $('.menuCategory li.selected').offset().left;
            $('.prd_menupackage ').scrollLeft(l_pos - 40);
        }
    }
    menPackmo();
    /**
...
/** 모바일쇼핑몰 슬라이딩메뉴 **/
$(document).ready(function () {
    $('#container').append('<div id="dimmedSlider"></div>');
    var offCover = {
        init: function () {
            $(function () {
                offCover.resize();
        ...
        layout: function () {
            if ($('html').hasClass('expand')) {
                ...
                $(".expand #main #header .topband_banner_wrap").css("color", main_color_after);
                $(".expand #main #header #top_promotionBanner").css("border-color", main_color_after);
                $(".expand #main #header .header_wrap .hamber_momenu li svg").css("fill", main_color_after);
                $(".expand #main #header .header_wrap .hamber_momenu button span").css("background-color", main_color_after);
                $(".expand #main #header.logocenter .header_wrap .logo_area > .xans-layout-logotop img.topimage1").css("display", "none");
                $(".expand #main #header.logocenter .header_wrap .logo_area > .xans-layout-logotop img.topimage2").css("display", "block");
            } else {
                setTimeout(function () {
                    $('#aside').css({ 'visibility': '' });
                }, 300);
                $("#main #header .topband_banner_wrap").css("color", main_color_before);
                $("#main #header #top_promotionBanner").css("border-color", main_color_before);
                $("#main #header .header_wrap .hamber_momenu li svg").css("fill", main_color_before);
                $("#main #header .header_wrap .hamber_momenu button span").css("background-color", main_color_before);
                $("#main #header.logocenter .header_wrap .logo_area > .xans-layout-logotop img.topimage1").css("display", "block");
                $("#main #header.logocenter .header_wrap .logo_area > .xans-layout-logotop img.topimage2").css("display", "none");
            }
            $('#aside').css({ 'visibility': 'visible' });
        },
        resize: function () {
